...
<body>
   <table style="width:100%; height: 100%;">
      ...
      <tr style="height: 10%;">
         <td align="center"><h1><a href="/"><img src="/logo/logo.png" alt=""></a></h1></td>
         <td rowspan="2">
            ...
            <div style="padding-left:10px; padding-top: 10px; padding-right: 10px;">
               <c:forEach items="${codes}" var="code" varStatus="status">
                  <form action="<c:url value="/main/index" />" id="form_type" name="form_type" method="post" >
                     ...
                     <button type="submit" id="button1" name="ok" class="btn btn-info btn-block btn-lg"><c:out value="${code.name }"></c:out></button>
                    </div>
                 </form>
              </c:forEach>
         </div>
   ...
   <script>
    ...
    <div class="container">
   <input type="hidden" id="modal" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" />
   <!-- Modal -->
