     	...
     	<div>
         	<form id="form_search" name="form_search" class="form-inline" action="/restaurant/list" method="post">
            	<div align="left" style="width:50%; float:left;margin-top: 10px; margin-bottom: 10px;">
                  	<input type="text" class="form-control" id="searchKeyword" name="searchKeyword" placeholder="음식점명" value="${restaurant.searchKeyword}" onKeyPress="if(event.keyCode==13) {return false;}" /> 
                  	...
                  	<a href="<c:url value="/restaurant/list" />">
                   		<input type="button" class="btn btn-default" id="button_view" name="button_view" value="전체" />
                   	</a>
            	</div>               
            	<div align="right" style="width:50%; float:left;margin-top: 10px; margin-bottom: 10px;">
                  	<a href="<c:url value="/admin/logout" />">
                    	<input type="button" class="btn btn-default" id="button_view" name="button_view" value="로그아웃" />
                    </a>
            	</div>               
          	</form>
      	</div>
