...
<body>
   ...
   <script>
      ...
      naver.maps.Event.addListener(map, 'click', function(e) {
         ...
         var xCoordinate = document
         .getElementById("xCoordinate");
         xCoordinate.value = xChange;
         
         var yCoordinate = document
         .getElementById("yCoordinate");
         yCoordinate.value = yChange;
         
         var xCoordinate1 = document
         .getElementById("xCoordinate1");
         xCoordinate1.value = xChange;

         var yCoordinate1 = document
         .getElementById("yCoordinate1");
