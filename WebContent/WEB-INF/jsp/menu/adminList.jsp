...
<body>
	...
	<table border="1" width="50%" align="center" class="table table-striped table-bordered">
		<tr>
			<td colspan="6" align="center">${listMenu[0].restaurantName }</td>
		</tr>
		<tr>
		...
		<c:if test="${!empty listMenu}">
			<c:forEach items="${listMenu }" var="menu" varStatus="status">
				<tr>
					...
					<td align="center">
							<c:forEach items="${codes}" var="codes" varStatus="status">
					...
					<td align="center"><c:out value="${menu.price }"></c:out></td>
                   	<%-- <td align="center">
	                    <img id="img_${count.count }" src="/img/${picture.logicalName}_${picture.physicalName}"
