		...
		<div align="center">
   		...
   		<div align="right">
	        ...
	        <a href="<c:url value="/menu/addform/${menu.restaurantNo}" />">
	        	<input type="button" class="btn btn-default" id="button_view" name="button_view" value="메뉴 등록" />
	        </a>
	        <a href="<c:url value="/restaurant/list" />"> 
	        	<input type="button" class="btn btn-default" id="button_view" name="button_view" value="음식점 목록으로" />
	       	</a>
	   	</div>
   	</div>
